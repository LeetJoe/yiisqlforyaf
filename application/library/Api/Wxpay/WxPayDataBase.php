	...
	**/
	public function ToXml()
	{
		if(!is_array($this->values) 
			|| count($this->values) <= 0)
		{
    		throw new Api_Wxpay_WxPayException("数组数据异常！");
    	}
	...
	{	
		if(!$xml){
			throw new Api_Wxpay_WxPayException("xml数据异常！");
		}
        # 将XML转为array
        # 禁止引用外部xml实体
	...
	public function MakeSign()
	{
		...
		$string = $string . "&key=".$wxPayConfig['wx']['key'];
		# 签名步骤三：MD5加密
		$string = md5($string);
		# 签名步骤四：所有字符转为大写
 ...
 *
 */
class Api_Wxpay_WxPayOrderQuery extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayCloseOrder extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayRefund extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayRefundQuery extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayDownloadBill extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayReport extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayShortUrl extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayMicroPay extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayReverse extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayJsApiPay extends Api_Wxpay_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class Api_Wxpay_WxPayBizPayUrl extends Api_Wxpay_WxPayDataBase
{
		/**
	* 设置微信分配的公众账号ID
	* @param string $value 
