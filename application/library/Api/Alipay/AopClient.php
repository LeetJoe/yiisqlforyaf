...
class Api_Alipay_AopClient {
	...
	protected function curl($url, $postFields = null) {
		...
		\Helper\Log::write('ALIPAYSDK', array('url' => $url, 'data' => $postFields, 'ch' => $ch, 'res' => $reponse), 'pay');
	...
	protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt) {
		...
		\Helper\Log::write('ALIPAYSDK', $logData, 'pay');
	}
	...
	*/
	...
	function parserJSONSignData($request, $responseContent, $responseJSON) {
		...
		$signData = new Api_Alipay_SignData();
	...
	private function parserEncryptJSONItem($responseContent, $nodeName, $nodeIndex) {
		...
		$encryptParseItem = new Api_Alipay_EncryptParseItem();
	...
	private function parserEncryptXMLItem($responseContent, $nodeName, $nodeIndex) {
		...
		if($indexOfXmlNode<0){
			$item = new Api_Alipay_EncryptParseItem();
