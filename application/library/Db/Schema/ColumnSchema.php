<?php
/**
 * Db_Schema_ColumnSchema class file.
 *
...
/**
 * Db_Schema_ColumnSchema class describes the column meta data of a database table.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.db.schema
 * @since 1.0
 */
class Db_Schema_ColumnSchema
{
	/**
	...
	{
		if(gettype($value)===$this->type || $value===null || $value instanceof Db_Schema_Expression)
			return $value;
