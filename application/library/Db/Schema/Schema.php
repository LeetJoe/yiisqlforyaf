...
/**
 * Db_Schema_Schema is the base class for retrieving metadata information.
 *
 * @property Db_Connection            $dbConnection Database connection. The connection is active.
 * @property array                    $tables The metadata for all tables in the database.
 * Each array element is an instance of {@link Db_Schema_TableSchema} (or its child class).
 * The array keys are table names.
 * @property array                    $tableNames All table names in the database.
 * @property Db_Schema_CommandBuilder $commandBuilder The SQL command builder for this connection.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.db.schema
 * @since 1.0
 */
abstract class Db_Schema_Schema
{
	/**
...
*@param string $name table name
	 *
*@return Db_Schema_TableSchema driver dependent table metadata, null if the table does not exist.
	 */
	 ...
	 * Constructor.
	 *
*@param Db_Connection $conn database connection.
	 */
	...
	/**
	 * @return Db_Connection database connection. The connection is active.
	 */
...
*@param string $name table name
	 ...
	 *
*@return Db_Schema_TableSchema table metadata. Null if the named table does not exist.
	 */
	...
	/**
	 * @return Db_Schema_CommandBuilder the SQL command builder for this connection.
	 */
	 ...
	 *
	 * @param Db_Schema_TableSchema $table the table schema whose primary key sequence will be reset
...
*@since 1.1
	 ...
	 * @return Db_Schema_CommandBuilder command builder instance
	 */
	protected function createCommandBuilder()
	{
		return new Db_Schema_CommandBuilder($this);
	}
	...
	{
		throw new Exception('{class} does not support fetching all table names.');
	}
