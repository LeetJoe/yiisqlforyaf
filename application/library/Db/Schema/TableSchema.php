<?php
/**
 * Db_Schema_TableSchema class file.
 *
...
/**
 * Db_Schema_TableSchema is the base class for representing the metadata of a database table.
 *
 * It may be extended by different DBMS driver to provide DBMS-specific table metadata.
 *
 * Db_Schema_TableSchema provides the following information about a table:
 * <ul>
 * <li>{@link name}</li>
 * <li>{@link rawName}</li>
 * <li>{@link columns}</li>
...
class Db_Schema_TableSchema
{
	...
	/**
	 * @var array Db_Schema_ColumnSchema metadata of this table. Each array element is a Db_Schema_ColumnSchema object, indexed by column names.
	 */
	 ...
	 * @return Db_Schema_ColumnSchema metadata of the named column. Null if the named column does not exist.
	 */
