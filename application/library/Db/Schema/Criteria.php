...
/**
 * Db_Schema_Criteria represents a query criteria, such as conditions, ordering by, limit/offset.
 *
...
*@param mixed $condition the new condition. It can be either a string or an array of strings.
	 ...
	 *
*@return Db_Schema_Criteria the criteria object itself
	 */
...
*@param string $column the name of the column to search between.
	 ...
	 * @param mixed $criteria the criteria to be merged with. Either an array or Db_Schema_Criteria.
