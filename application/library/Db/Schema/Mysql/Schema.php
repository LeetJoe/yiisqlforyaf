<?php
/**
 * Db_Schema_Mysql_Schema class file.
 *
...
/**
 * Db_Schema_Mysql_Schema is the class for retrieving metadata information from a MySQL database (version 4.1.x and 5.x).
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.db.schema.mysql
 * @since 1.0
 */
class Db_Schema_Mysql_Schema extends Db_Schema_Schema
{
	/**
...
*@param string $name table name
	 *
*@return Db_Schema_Mysql_TableSchema driver dependent table metadata. Null if the table does not exist.
	 */
	protected function loadTable($name)
	{
		$table = new Db_Schema_Mysql_TableSchema;
	 ...
	 *
	 * @param Db_Schema_Mysql_TableSchema $table the table instance
	 ...
	 *
	 * @param Db_Schema_Mysql_TableSchema $table the table metadata
	 *
...
*@param array $column column metadata
	 *
*@return Db_Schema_ColumnSchema normalized column metadata
	 */
	protected function createColumn($column)
	{
		$c=new Db_Schema_Mysql_SchemaColumnSchema;
		$c->name=$column['Field'];
	...
	{
		return new Db_Schema_Mysql_SchemaCommandBuilder($this);
	}
