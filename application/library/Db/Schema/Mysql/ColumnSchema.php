<?php
/**
 * Db_Schema_Mysql_SchemaColumnSchema class file.
 *
...
/**
 * Db_Schema_Mysql_SchemaColumnSchema class describes the column meta data of a MySQL table.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.db.schema.mysql
 * @since 1.0
 */
class Db_Schema_Mysql_SchemaColumnSchema extends Db_Schema_ColumnSchema
{
	/**
