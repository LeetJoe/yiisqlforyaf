<?php
/**
 * Db_Schema_Expression class file.
 *
...
/**
 * Db_Schema_Expression represents a DB expression that does not need escaping.
 * Db_Schema_Expression is mainly used in {@link CActiveRecord} as attribute values.
 * When inserting or updating a {@link CActiveRecord}, attribute values of
 * type Db_Schema_Expression will be directly put into the corresponding SQL statement
